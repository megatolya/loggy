 ...
 * @return {Object} с ключами {Date} date, {String} module, {String} level, {Array} msg (может состоять из строк и объектов)
 */
...
exports.processFile = function (filePath, callback) {
	fs.readFile(filePath, {encoding: "utf8"}, function (err, fileContents) {
		...
		callback(parseLogData(fileContents));
	});
};
